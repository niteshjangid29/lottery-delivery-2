      ...
      <div className="space-y-6">
        <div className="p-4 bg-gray-100 rounded-lg shadow-md flex items-center">
          ...
          <div className="ml-4">
            ...
            <p className="text-gray-600">
              Browse through the list of available lotteries and pick the one
        ...
        <div className="p-4 bg-gray-100 rounded-lg shadow-md flex items-center">
          ...
          <div className="ml-4">
            ...
            <p className="text-gray-600">
              Choose your lottery numbers and decide how many tickets you'd like
              to purchase.
            </p>
          </div>
        </div>
        ...
        <div className="p-4 bg-gray-100 rounded-lg shadow-md flex items-center">
          ...
          <div className="ml-4">
            ...
            <p className="text-gray-600">
              Complete the payment process securely and easily by clicking on
              the "Buy Now" button.
            </p>
          </div>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg shadow-md flex items-center">
          ...
          <div className="ml-4">
            ...
            <p className="text-gray-600">
              After a successful payment, your ticket will be delivered. Relax
